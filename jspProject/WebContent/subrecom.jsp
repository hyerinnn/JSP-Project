...
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/jspProject",
	...
	out.println("<tr><td align ='center'><h2>추천받기</h2></td>");
	out.println("<a href ='recomselect.html'><input type='button' name='버튼' value='지역으로 검색'></a>");
	out.println("<a href ='recomselect2.html'><input type='button' name='버튼' value='테마로 검색'></a>");
	out.println("<a href ='recomselect3.html'><input type='button' name='버튼' value='계절로 검색'></a></tr>");
	out.println("</table>");
	...
	while(rs.next()) {
		...
		out.println("<a href='subrecom2.jsp?title=" + rs.getString("title")+"''><img src='imageView3.jsp?title=" + rs.getString("title") + "'+ width=300 height=250>");
