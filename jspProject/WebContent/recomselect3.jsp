...
<center>
<form method="post" action="recomselect33.jsp">

<br><br><br><br>
<% 

out.println("계절: " + request.getParameter("season")+"<br><br><br>");
out.println("위의 사항이 일치하면 확인!");
out.println("<br><br><a href='recomselect33.jsp?season=" + request.getParameter("season")+"''>확인</a>");
