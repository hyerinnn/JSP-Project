...
<center>
<form method="post" action="recomselect22.jsp">

<br><br><br><br>
<% 

out.println("테마: " + request.getParameter("tema")+"<br><br>");

out.println("위의 사항이 일치하면 확인!");
out.println("<br><br><a href='recomselect22.jsp?tema=" + request.getParameter("tema")+"''>확인</a>");
