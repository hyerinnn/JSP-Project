...
PreparedStatement pstmt = conn.prepareStatement("INSERT INTO recom VALUES(?, ?, ?, ?, ?, ?, ?, ?)");


pstmt.setString(1, userId);
pstmt.setString(2, userPlace);
pstmt.setString(3, userTema);
pstmt.setString(4, userSeason);
pstmt.setString(5, userTitle);
pstmt.setString(6, userContent);
pstmt.setBytes(7, userImage);
pstmt.setString(8, (new SimpleDateFormat("yyyy-MM-dd")).format(new Date()));
int count = pstmt.executeUpdate();


if ( count > 0) { 
	response.sendRedirect("subrecom.jsp");
	}
else {
